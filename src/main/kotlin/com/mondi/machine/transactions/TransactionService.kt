...
import com.mondi.machine.storage.supabase.SupabaseService.Companion.BUCKET_CERTIFICATES
...
class TransactionService(
    ...
    suspend fun create(
        ...
        val certificateUrl = supabaseService.uploadFile(
            BUCKET_CERTIFICATES,
     ...
     * @return the [Transaction] instance.
     */
    suspend fun update(id: Long, request: TransactionRequest): Transaction {
